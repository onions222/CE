...
VISUAL_ITEM_METADATA = {
    ...
    "near_node_ramp_chart": _visual_meta(
        dataset_role="neutral_stability_core",
        priority="P0",
        visual_risk=["luma_node_discontinuity", "local_green_cast", "highlight_transition_artifact"],
        expected_observation="Local grey ramps centered on each node remain smooth and neutral across the node crossing.",
        expected_artifact_if_fail="A local ramp bends in hue or shows a visible jump near the center node.",
        recommended_wa_sel=[0, 64, 127],
        suggested_metrics=["near_node_local_jump", "local_green_bias_peak"],
        pass_hint="Inspect high-luma node ramps for hue kinks, especially around 223/239/247/255.",
    ),
