...
def main(argv: list[str] | None = None) -> None:
    ...
    parser.add_argument("--frac-bits", type=int, default=10,
                        help="Fractional bits for linear pixel internal precision (default 10)")
    parser.add_argument("--coeff-frac-bits", type=int, default=8, choices=[8, 10],
                        help="Gain coefficient fractional bits: 8 (UQ1.8) or 10 (UQ1.10)")
    ...
    print(
        f"Saved: {args.output}  "
        f"(wa_sel={cfg.wa_sel}, frac_bits={cfg.frac_bits}, coeff_frac_bits={cfg.coeff_frac_bits})"
    )
